...
//Answer: You would use const when you know the value of the variable will not change
const food = "tacos"
let drink = "beer"
let myName = "Danielle"
let myFriendsName = "Morgan"
...
console.log(`My friend, ${myFriendsName}, and I are going out for ${food} and ${drink}.`)
...
//Answer: The error says "Assignment to constant variable." This means that the variable cannot be reassigned value.
drink = "margaritas"
console.log(drink)
 ...
 * Step 2: Have the function 'return' the same sentence you used to describe eating lunch above
...
const lunchTime = (foodChoice, drinkChoice) => {
    ...
    return `My friend, ${myFriendsName}, and I are going out for ${foodChoice} and ${drinkChoice}.`
}
console.log(lunchTime('Pizza', 'Water'))
...
// return `My friend, ${myFriendsName}, and I are going out for ${food} and ${drink}.`
// }
...
console.log(foodForTodayAndTomorrow("tacos", "beer", lunchTime('breakfast', 'mimosas')))
